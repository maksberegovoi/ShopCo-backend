...
-- CreateEnum
CREATE TYPE "ProductSize" AS ENUM ('M', 'S', 'L', 'XL', 'XXL');
...
-- AddForeignKey
ALTER TABLE "Attribute" ADD CONSTRAINT "Attribute_attributeGroupId_fkey" FOREIGN KEY ("attributeGroupId") REFERENCES "AttributeGroup"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
